...
cv::Rect MU3(190, 15, 1000, 925);
cv::Rect DepthTu3(500, 400, 100, 100);

void ExcuseMode3::execusemode2(TYcamera& a, RobotControl& b, chooseblack& c, complexIm& d)
{
    tu = MU3;
    ...
    while (1)
    {
        ...
        d.getDepth(imageDepthP, FirstPaperZ, DepthTu3);
...
void ExcuseMode3::NewExecusemode(TYcamera& a, RobotControl& b, chooseblack& c, complexIm& d)
{
    tu = MU3;
    ...
    while (1)
    {
        ...
        while (FirstPaperZ == 0) { d.getDepth(imageDepthP, FirstPaperZ, DepthTu3); }
       ...
       // cv::Mat depth1 = depthn.clone();
        ...
        if (NeedZ < MaxWorkZ + 200)
        {
            ...
            d.NewGetRobPP(imcenters, robcenters, NeedZ, Robx, Roby, Robz, Robwt1, Robwt2, NowLayerZ);
            while (!WorkProcess);   //暂停处
